...
VertexCompilerTextureAdvanced::VertexCompilerTextureAdvanced() {
}

VertexCompilerTextureAdvanced::~VertexCompilerTextureAdvanced() {
}

Point VertexCompilerTextureAdvanced::Decode(const std::vector<std::vector<float>>& attributes) {
    Point point_attri;
...
uint32_t VertexCompilerTextureAdvanced::AttributeCount() {
    return 3;
}